...
public class TabletSettingActivity extends AppCompatActivity implements View.OnClickListener{
            ...
            case R.id.btnApiCon:
                if (Patterns.IP_ADDRESS.matcher(this._edIP.getText().toString()).matches()) {
                    if (this._edRack.getText().toString().isEmpty() || this._edSlot.getText().toString().isEmpty()) {
                        ...
                        Intent tablet = new Intent(this, TabletPackagingActivity.class);
